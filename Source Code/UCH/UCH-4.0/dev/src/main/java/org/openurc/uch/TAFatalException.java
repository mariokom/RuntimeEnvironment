...
/**
 * This allows developers to distinguish TA Fatal exceptions from Java 
 ...
 */
public class TAFatalException extends Exception {
     ...
     */
    public TAFatalException(String message) {
        super(message);
    }
     ...
     */
    public TAFatalException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause The Throwable cause.
     */
    public TAFatalException(Throwable cause) {
        super(cause);
    }
