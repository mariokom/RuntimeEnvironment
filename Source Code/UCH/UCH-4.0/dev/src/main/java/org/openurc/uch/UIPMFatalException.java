...
/**
 * This class allows developers to distinguish UIPM Fatal exception from Java 
 * exceptions.
 *  
...
public class UIPMFatalException extends Exception{
     ...
     */
    public UIPMFatalException(String message, Throwable cause) {
        super(message, cause);
    }
