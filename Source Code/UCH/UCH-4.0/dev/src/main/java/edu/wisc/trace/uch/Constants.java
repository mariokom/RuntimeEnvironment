...
public final class Constants {
	public static final String CONSTANT_XML_HEADER = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";
	public static final String FILE_NAME = "http://openurc.org/ns/res#filename";
	// Used in Local files
	...
	public static final String CONTEXT_INIT_PARAM_NAME_IP_ADDRESS = "ipAddress";
	public static final String CONTEXT_INIT_PARAM_NAME_PORT_NO = "portNo";
	public static final String CONTEXT_INIT_PARAM_NAME_RESSERVER_USER_NAME = "resserver.username";
	public static final String CONTEXT_INIT_PARAM_NAME_RESSERVER_PASSWORD = "resserver.password";
	public static final String CONTEXT_INIT_PARAM_NAME_RESSERVER_APP_PATH = "resserver.appPath";
	...
	static final String RESSERVER_USER_STATUS_GUEST = "guest";
	 ...
	 public static final String PROPERTY_RES_RESOURCE_SERVER_USER_NAME = "http://openurc.org/ns/res#username"; // Parikshit Thakur : 20110901. Added new constant for username property to be used for a user profile.
	 public static final String PROPERTY_RES_SUBSCRIPTION_PACAKAGE = "http://openurc.org/ns/res#subscriptionPackage";
	 ...
	 public static final String PROPERTY_RUNTIME_PLATFORM = "http://openurc.org/ns/res#runtimePlatform";// Parikshit Thakur : 20110901. Changed from platform to runtimePlatform.
	 ...
	 public static final String PROPERTY_FOR_TARGET_INSTANCE = "http://openurc.org/ns/res#forTargetInstance";
	 public static final String PROPERTY_MIME_TYPE = "http://openurc.org/ns/res#mimeType";
	 public static final String PROPERTY_FOR_DOMAIN = "http://openurc.org/ns/res#forDomain";
	 ...
	 public static final String NODE_NAME_PROP = "prop";
	 public static final String NODE_NAME_PROPS = "props";
	...
	//value of PROPERTY_RES_INSTANCE_ID
	 ...
	 public static final String USERPROFILE_RESOURCE_NAME_PREFIX = "http://openurc.org/ns/userprof";
	 
	 // User profile content properties.
	 public static String USER_PROFILE_PROPERTY_LANGUAGES = "http://openurc.org/ns/userprof#languages";
	 public static String USER_PROFILE_PROPERTY_UIPM_FAVORITE_PUBLISHER = "http://openurc.org/ns/userprof#uipm-favorite-publisher";
	 public static String USER_PROFILE_PROPERTY_UIPM_FAVORITE_SUBSCRIPTION_PACKAGE = "http://openurc.org/ns/userprof#uipm-favorite-subscriptionPackage";
	 public static String USER_PROFILE_PROPERTY_UIPM_FAVORITE_NAME = "http://openurc.org/ns/userprof#uipm-favorite-name";
	...
	//public static final String PRET_CONFORMS_TO_URI = "http://openurc.org/iso24752-3/2007";
	 ...
	 // Get CompatibleUIS filter parameters names:
	 
	 public static final String UILIST_REQUEST_PARAMETER_TARGET_NAME = "targetName";
	 public static final String UILIST_REQUEST_PARAMETER_SOCKET_NAME = "socketName";
	 public static final String UILIST_REQUEST_PARAMETER_TARGET_ID = "targetId";
	 public static final String UILIST_REQUEST_PARAMETER_FAVORITEUIPMCLIENTS = "favoriteUipmClients";
