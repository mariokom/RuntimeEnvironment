...
public class TestUCH implements ITAListener {
	ITA ta;
	private Map<String, String> uchProps;
	private Map<String, String> taProps;
public TestUCH(ITA ta){
	this.ta = ta;
}

public void testTA() throws TAException, TAFatalException{
	ta.init(this, uchProps,taProps);	
}
