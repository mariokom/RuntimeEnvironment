package eu.asterics.component.actuator.uchelectricityoutlet.uchCommunication;
...
import eu.asterics.component.actuator.uchelectricityoutlet.uchCommunication.session.requests.GetDependenciesRequest;
import eu.asterics.component.actuator.uchelectricityoutlet.uchCommunication.session.requests.GetResourceRequest;
import eu.asterics.component.actuator.uchelectricityoutlet.uchCommunication.session.requests.GetResourcesWithPropRequest;
import eu.asterics.component.actuator.uchelectricityoutlet.uchCommunication.session.requests.GetUpdatesRequest;
import eu.asterics.component.actuator.uchelectricityoutlet.uchCommunication.session.requests.GetValuesRequest;
import eu.asterics.component.actuator.uchelectricityoutlet.uchCommunication.session.requests.SetValuesRequest;
import eu.asterics.component.actuator.uchelectricityoutlet.utils.HttpCommunicator;
import eu.asterics.component.actuator.uchelectricityoutlet.utils.HttpResponse;
